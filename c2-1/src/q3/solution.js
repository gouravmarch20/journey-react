...
const blueJeans = storeData.women.jeans.availability.find(
  item => item.color === 'dark blue' && item.inStock
)

console.log(blueJeans.quantity)


const getWalletQuantity = (acc , curr)=>{

}
const menWallet = storeData.men.wallet.availability.reduce(
  getWalletQuantity,
  (quantity = 0)
)
console.log(menWallet)
